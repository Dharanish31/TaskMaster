...
const AdminReservations = () => {
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-4">All Completed Tasks</h2>
      <div className="table-responsive">
        <table className="table table-bordered table-hover align-middle">
          <thead className="table-light">
            <tr>
              <th onClick={() => handleSort("id")} style={{ cursor: "pointer" }}>User ID</th>
              <th onClick={() => handleSort("eventDate")} style={{ cursor: "pointer" }}>Date</th>
              <th onClick={() => handleSort("userName")} style={{ cursor: "pointer" }}>User</th>
              <th onClick={() => handleSort("eventName")} style={{ cursor: "pointer" }}>Task Name</th>
            </tr>
          </thead>
          <tbody>
