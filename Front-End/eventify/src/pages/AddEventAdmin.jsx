...
const AddEventAdmin = () => {
    ...
    return (
        <div className="container mt-5 mb-5">
            <h2 className="mb-4 text-center">Create a New Task</h2>
            ...
            <form onSubmit={handleSubmit} className="shadow p-4 bg-white rounded">
                ...
                <div className="row mb-3">
                    ...
                    <div className="col-md-6">
                        <label className="form-label"><FaClock className="me-2" />End Time</label>
                ...
                <div className="mb-4">
                    <label className="form-label"><FaInfoCircle className="me-2" />Upload File</label>
                    <input type="file" className="form-control" name="imageURL"  rows={4} />
                </div>
