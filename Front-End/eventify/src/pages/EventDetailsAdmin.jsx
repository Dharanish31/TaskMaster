  ...
  return (
    <div className="container py-4">
        ...
        <div className="mb-3 row">
            ...
            {!isEditing ? (
                <p className="form-control-plaintext">{items.date}&{items.time}</p>
            ) : (
                <input
                type="date"
                className="form-control"
        ...
        {/* Location */}
        {/* <div className="mb-3 row">
            <label htmlFor="eventLocation" className="col-sm-2 col-form-label"></label>
            <div className="col-sm-10">
            {!isEditing ? (
                <p className="form-control-plaintext"></p>
            ) : (
        ...
        {/* Capacity */}
        {/* <div className="mb-3 row">
            <label htmlFor="eventCapacity" className="col-sm-2 col-form-label"></label>
            <div className="col-sm-10">
            {!isEditing ? (
                <p className="form-control-plaintext"></p>
            ) : (
        ...
        {/* Duration */}
        {/* <div className="mb-3 row">
            <label htmlFor="eventDuration" className="col-sm-2 col-form-label"></label>
            <div className="col-sm-10">
            {!isEditing ? (
                <p className="form-control-plaintext"></p>
            ) : (
        ...
        {/* Fee */}
        {/* <div className="mb-3 row">
            <label htmlFor="eventFee" className="col-sm-2 col-form-label"></label>
            <div className="col-sm-10">
            {!isEditing ? (
                <p className="form-control-plaintext"></p>
            ) : (
