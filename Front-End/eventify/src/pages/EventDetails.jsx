  ...
  return (
    <div className="container py-4">
      ...
      {isSoldOut(items.capacity, reservations) ? (
        ...
        <button onClick={booking} className="border border-green-500 text-green-500 px-4 py-2 mt-2 disabled">COMPLETED</button>
      ):(
        <button onClick={booking} className="border border-green-500 text-green-500 px-4 py-2 mt-2 blueBtn">MARK AS COMPLETED</button>
      )} 
    </div>
  );
}
