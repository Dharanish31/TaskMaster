...
import logomain from '../Images/pm.jpg'; 
        ...
        <div className="w-100 px-4" style={{ maxWidth: "1440px" }}>
          <div className="d-flex align-items-center justify-content-between py-4">
            ...
            >
              ...
              <span
                style={{
                  background: 'linear-gradient(90deg, #2B5DAE, #34a3da, #00d2ff)',
              ...
              {adminUsername ? (
                <>
                  <nav className="d-none d-lg-flex gap-3">
                    ...
                    <Link to="/EventsPageAdmin" className="text-dark text-decoration-none nav-link">Tasks</Link>
                ...
                <>
                  <nav className="d-none d-lg-flex gap-3">
                    ...
                    <Link to="/events" className="text-dark text-decoration-none nav-link">Tasks</Link>
                  ...
                  {isLoggedIn ? (
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                        ...
                        <li><Link className="dropdown-item" to={`/reservations/${username}`}>My Task Records</Link></li>
